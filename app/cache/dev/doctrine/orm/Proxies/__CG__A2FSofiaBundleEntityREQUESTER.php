 ...
 */
class REQUESTER extends \A2F\SofiaBundle\Entity\REQUESTER implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'A2F\\SofiaBundle\\Entity\\REQUESTER' . "\0" . 'position', '' . "\0" . 'A2F\\SofiaBundle\\Entity\\REQUESTER' . "\0" . 'notes', '' . "\0" . 'A2F\\SofiaBundle\\Entity\\REQUESTER' . "\0" . 'client', 'lastName', 'firstName', 'landLinePhoneNumber', 'mobilePhoneNumber', 'email', 'roles', 'salt', 'username', 'password', 'live');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (REQUESTER $proxy) {
