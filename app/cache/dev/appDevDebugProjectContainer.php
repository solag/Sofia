...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.a2fsofia_firewall' => 'getSecurity_Firewall_Map_Context_A2fsofiaFirewallService',
            'security.firewall.map.context.a2fsofia_login' => 'getSecurity_Firewall_Map_Context_A2fsofiaLoginService',
            ...
            'security.user.provider.concrete.dba' => 'getSecurity_User_Provider_Concrete_DbaService',
            'security.user.provider.concrete.global' => 'getSecurity_User_Provider_Concrete_GlobalService',
            'security.user.provider.concrete.req' => 'getSecurity_User_Provider_Concrete_ReqService',
            ...
            'sofiabundle.doctrineprefix_subscriber' => 'getSofiabundle_DoctrineprefixSubscriberService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('sofiabundle.doctrineprefix_subscriber'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'SOFIA', 'user' => 'root', 'password' => 'Nantes44!', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\A2F\\SofiaBundle\\Entity'))), 'A2F\\SofiaBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('A2FSofiaBundle' => 'A2F\\SofiaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7015b7cd0b69ded82b9b8dd68cede13a206b524bbb5969e56a558a2d41209281');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('A2F\\SofiaBundle\\Entity\\USER' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.A2FSofia_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.A2FSofia_firewall' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.a2fsofia_firewall' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_A2fsofiaFirewallService()
    {
        ...
        $g->setProviderKey('A2FSofia_firewall');
        ...
        return $this->services['security.firewall.map.context.a2fsofia_firewall'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.global'), 1 => $this->get('security.user.provider.concrete.dba'), 2 => $this->get('security.user.provider.concrete.req')), 'A2FSofia_firewall', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'A2FSofia_firewall', $g, $h, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'A2FSofia_firewall', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'login', false), NULL, NULL, $b));
    }

    /**
     * Gets the 'security.firewall.map.context.a2fsofia_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_A2fsofiaLoginService()
    {
        $a = $this->get('security.context');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.a2fsofia_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.global'), 1 => $this->get('security.user.provider.concrete.dba'), 2 => $this->get('security.user.provider.concrete.req')), 'A2FSofia_login', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '556ecd8322adc', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'A2FSofia_login', NULL, NULL, NULL, $b));
    }
    ...
    /**
     * Gets the 'sofiabundle.doctrineprefix_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \A2F\SofiaBundle\Subscriber\TablePrefixSubscriber A A2F\SofiaBundle\Subscriber\TablePrefixSubscriber instance.
     */
    protected function getSofiabundle_DoctrineprefixSubscriberService()
    {
        return $this->services['sofiabundle.doctrineprefix_subscriber'] = new \A2F\SofiaBundle\Subscriber\TablePrefixSubscriber('GT_');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('sofia.lagacherie');
        $a->setPassword('Grenouille.47');
        $a->setAuthMode('login');
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('A2FSofia_firewall', 'logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\A2F\\SofiaBundle/Resources/views'), 'A2FSofia');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ThisTokenIsNowSecretSoNoNeedToChangeIt');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('556ecd8322adc'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.global'), new \Symfony\Component\Security\Core\User\UserChecker(), 'A2FSofia_firewall', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_DBA' => array(0 => 'ROLE_DBA'), 'ROLE_REQ' => array(0 => 'ROLE_REQ'), 'ROLE_ADMIN' => array(0 => 'ROLE_DBA', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }

    /**
     * Gets the 'security.user.provider.concrete.dba' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_DbaService()
    {
        return $this->services['security.user.provider.concrete.dba'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'A2F\\SofiaBundle\\Entity\\DBA', 'username', NULL);
    }

    /**
     * Gets the 'security.user.provider.concrete.global' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_GlobalService()
    {
        return $this->services['security.user.provider.concrete.global'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('security.user.provider.concrete.dba'), 1 => $this->get('security.user.provider.concrete.req')));
    }

    /**
     * Gets the 'security.user.provider.concrete.req' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider A Symfony\Bridge\Doctrine\Security\User\EntityUserProvider instance.
     */
    protected function getSecurity_User_Provider_Concrete_ReqService()
    {
        return $this->services['security.user.provider.concrete.req'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'A2F\\SofiaBundle\\Entity\\REQUESTER', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'A2FSofiaBundle' => 'A2F\\SofiaBundle\\A2FSofiaBundle',
            ...
            'database_name' => 'SOFIA',
            'database_user' => 'root',
            'database_password' => 'Nantes44!',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'sofia.lagacherie',
            'mailer_password' => 'Grenouille.47',
            'locale' => 'fr',
            'secret' => 'ThisTokenIsNowSecretSoNoNeedToChangeIt',
            ...
            'kernel.secret' => 'ThisTokenIsNowSecretSoNoNeedToChangeIt',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sofia.lagacherie',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Grenouille.47',
